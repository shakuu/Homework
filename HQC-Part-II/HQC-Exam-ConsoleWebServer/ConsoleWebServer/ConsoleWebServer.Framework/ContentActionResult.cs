...
{
    public ContentActionResult(IHttpRequestManager requestManager, object model)
    {
        this.model = model;
...
{
    public ContentActionResultWithoutCaching(IHttpRequestManager requestManager, object model) : base(requestManager, model)
    {
...
{
    public ContentActionResultWithCorsWithoutCaching(IHttpRequestManager requestManager, object model, string corsSettings) : base(requestManager, model)
    {
