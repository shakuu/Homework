...
namespace _09_Arithmetical_Expressions_2
{
    class ArithmeticalExpressions2
    {
        // static Vars
        ...
        public static int EvaluateFunction(int OperatorIndex)
        {
            ...
            OutputExpression[OperatorIndex] =
                    OutputExpression[OperatorIndex][0]
                    .ToString()
                    .ToUpper() +
                    OutputExpression[OperatorIndex];

            OutputExpression[OperatorIndex] =
                    OutputExpression[OperatorIndex].Remove(1, 1);
            ...
            {
                // call method
                OutputExpression[OperatorIndex - 1] =
                        (curMethod.Invoke(
                            typeof(Math),
                            new object[]
                            {
        ...
        public static int EvaluateFunc(Func<int> PassFunc)
        {
