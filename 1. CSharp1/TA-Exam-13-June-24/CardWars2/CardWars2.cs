        ...
        static void Main(string[] args)
        {
            ...
            for (int round = 0; round < matchLength; round++)
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    else if (Pesho.currCard == "Y")
                    {
                        Pesho.score += Score[Pesho.currCard];
                    }
                    else
                    {
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    else if (Gosho.currCard == "Y")
                    {
                        Gosho.score += Score[Gosho.currCard];
                    }
                    else
                    {
                ...
                //apply zCounter
                Pesho.score *= (int)Math.Pow(2, Pesho.zCounter);
                Gosho.score *= (int)Math.Pow(2, Gosho.zCounter);
